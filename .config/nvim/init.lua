          ...
          yamlls = {
            settings = {
              ...
              yaml = {
                ...
                schemas = {
                  -- Bitbucket's published schema puts its ref target under `components`, a sibling
                  -- of the root $ref, which draft-07 sibling-stripping deletes before resolving.
                  -- Refresh with schemas/update-bitbucket-pipelines-schema.py
                  [vim.fn.stdpath 'config' .. '/schemas/bitbucket-pipelines.json'] = '**/bitbucket-pipelines.yml',
                },
                customTags = {
                  -- '!And',
                  -- '!If',
